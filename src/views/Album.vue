<template>
  <div class="playlist">
        ...
        <div class="banner-brief">
          <div class="avatar">
            ...
            <span class="update-time"
              >发行时间: {{ albumLists.publishTime | showDate }}</span
            >
          </div>
    ...
    <div class="track-list">
      ...
      <div
        class="track-item"
        v-for="(albumSong, index) in albumSongs"
        :key="index"
        @click="submit(index)"
      >
        <img
          :src="albumLists.blurPicUrl"
          data-real="?param=224y224"
          class="lazy-img animated-bg"
          loading="lazy"
        />
